      ...
      <div className="container py-4">
        <div className="row g-4 text-center">
          ...
          <div className="col-md-4">
            ...
            <p className="small text-white-50">Naša vozila prolaze stroge kontrole, a uz svaku kupnju nudimo jamstvo na kvalitetu do 12 mjeseci.</p>
          </div>
          {/* Kvaliteta */}
          <div className="col-md-4">
            <i className="bi bi-star-fill text-gold fs-1 mb-3"></i>
            <h4 className="fw-bold text-uppercase">Provjerena kvaliteta</h4>
            <p className="small text-white-50">Svako vozilo u našem salonu je detaljno pregledano i servisirano prije same prodaje.</p>
          </div>
          {/* Tradicija */}
          <div className="col-md-4">
            <i className="bi bi-people-fill text-gold fs-1 mb-3"></i>
            <h4 className="fw-bold text-uppercase">Osobni pristup</h4>
            <p className="small text-white-50">Dugogodišnje iskustvo i tisuće zadovoljnih klijenata garancija su vaše sigurne kupnje.</p>
          </div>
        </div>
      </div>
    </div>
